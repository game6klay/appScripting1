...
define('SECRET_SALT','DBeTPXEuAUxcdZQbBadmplmwzkbarg2U');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','andrew.lam@verizonwireless.com');
...
define('DBUSER','osticketdbuser');
define('DBPASS','osTicket2016SPC');
