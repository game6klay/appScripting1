			...
			else
			{
				...
				else
				{
					...
					if($CreateAccountResult == 1)
					{
						...
						$subject = "Activate Survey App Today";
						$body = 
						"
							<html><body>
							Hello $Name,
							<br><br>
							Thank you for signing up for Survey. Click this link <a href=\"https://carvilus.com/survey/v1/activate/?a=$hash&email=$emailAddress\">https://carvilus.com/survey/v1/activate/?a=$hash&email=$emailAddress</a> to activate your account.
							<br><br>
							Regards,<br>
							Carvilus Team
							</body></html>
